...
public class UsuarioServiceImpl implements UserDetailsService, IUsuarioService {
	...
	public Usuario getUsuario() {
		Authentication a2 = SecurityContextHolder.getContext()
			    .getAuthentication();
		
		UserDetails userDetails = (UserDetails) a2.getPrincipal();
		return userRepo.findOneByNombre(userDetails.getUsername());
	}
